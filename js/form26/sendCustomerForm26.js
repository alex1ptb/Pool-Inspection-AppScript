function sendForm26(data, pdfURL) {
  ...
  let subject = `${data.address} - Form 26 Non-Conformity Notice - ${data.dateOfInspection}`;
  let body = `${name}, \n
...
\n
For any pool barrier remedial/building work it is recommended that you \n
engage a QBCC licensed tradesperson/builder who understands the required pool fence & safety regulations \n
and who will guarantee that their work will pass inspection.\n
\n
For any clarification regarding pool safety building/compliance/regulations\n
you may wish to refer to the Building Act 1975, Australian Standards 1926 \n
...
Once the changes have been made please contact our office via
email to arrange a new inspection:\n`;
