...
function jobConfirmationEmail() {
  ...
  //generate template
    ...
    var emailedStatusColumn = headerKeys[0].indexOf(jobConfirmationStatus)+1
    ...
    if(formResponse.getRange(2 + i, headerKeys[0].indexOf('Date of Inspection')+1).getDisplayValue() != ""){ 
    ...
    var htmlTemplate = HtmlService.createTemplateFromFile( "email_Template_JobDateConfirmation.html" );
